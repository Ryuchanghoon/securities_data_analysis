...
class DBUpdater:
    def __init__(self):
        ...
        self.conn = pymysql.connect(host = 'localhost', user = 'root',
                                    password = 'ak135790', db = 'INVESTAR', charset = 'utf8')
    ...
    def read_krx_code(self):
        ...
        url = r'C:\Users\rch\Desktop\대학관련\github\DB_connect\상장법인목록.xls' #
    ...
    def read_naver(self,code,company,pages_to_fetch):
        ...
        try:
            ...
            df = df.dropna()
            df[['close','diff','open','hugh','low','volume']] = df[['close','diff','open','high','low','volume']].astype(int)
            df = df[['date','open','high','low','close','diff','close','diff','volume']]
    ...
    def replace_daily_price(self, df, num, code, company):
        ...
        with self.conn.cursor() as curs:
            for r in df.itertuples():
                sql = "REPLACE INTO daily_price VALUES ('{}', '{}', {}, {}, {}, {}, {})".format(code, r.date, r.open, r.hith, r.low, r.close, r.diff, r.volume)
            curs.execute(sql)
        self.conn.commit()
